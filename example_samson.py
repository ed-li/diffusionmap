...
if __name__ == '__main__':
    # Load data
    data = np.loadtxt('samson.txt', delimiter=',')

    # Plot luminance
    plt.imshow(data.mean(axis=1).reshape((95, 95)), cmap='gray', origin='lower')
    plt.axis('off')
    plt.savefig('samson_luminance.png', bbox_inches='tight')
    plt.show()
    ...
    plt.imshow(e_y.reshape((95, 95)), origin='lower')
    plt.axis('off')
    plt.savefig('samson_euclidean.png', bbox_inches='tight')
    plt.show()
    ...
    plt.imshow(m_y.reshape((95, 95)), origin='lower')
    plt.axis('off')
    plt.savefig('samson_mahalanobis.png', bbox_inches='tight')
    plt.show()
    ...
    plt.imshow(lm_y.reshape((95, 95)), origin='lower')
    print("generated image")
    plt.axis('off')
    plt.savefig('samson_local_gmm_mahalanobis.png', bbox_inches='tight')
    plt.show()
