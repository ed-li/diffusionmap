...
if __name__ == '__main__':
    # Load data
    data = np.loadtxt('jasper_ridge.txt', delimiter=',')

    # Plot luminance
    plt.imshow(data.mean(axis=1).reshape((100, 100)), cmap='gray', origin='lower')
    plt.axis('off')
    plt.savefig('jasper_ridge_luminance.png', bbox_inches='tight')
    plt.show()
    ...
    plt.imshow(e_y.reshape((100, 100)), origin='lower')
    plt.axis('off')
    plt.savefig('jasper_ridge_euclidean.png', bbox_inches='tight')
    plt.show()
    ...
    plt.imshow(m_y.reshape((100, 100)), origin='lower')
    plt.axis('off')
    plt.savefig('jasper_ridge_mahalanobis.png', bbox_inches='tight')
    plt.show()
    ...
    plt.imshow(lm_y.reshape((100, 100)), origin='lower')
    print("generated image")
    plt.axis('off')
    plt.savefig('jasper_ridge_local_gmm_mahalanobis.png', bbox_inches='tight')
    plt.show()
